...
4. `projects/{プロジェクト名}/project-requirements.md` を作る
5. [harness/router.md](/Users/ryota/Desktop/エージェント作成/超速スプリント/harness/router.md) を見て最小手段を決める
6. 該当するフロー1つだけを読む
7. 必要なら `task-plan.md` と `progress.md` を追加する
...
```mermaid
flowchart TD
    A["interview-summary.md を受け取る"] --> B["共通ディスカバリー<br/>目的整理 / 解決手段の選定 / 成立条件の確認"]
