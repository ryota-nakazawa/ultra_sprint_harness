...
5. `python tools/count_tokens.py metrics/{プロジェクト名}-token-manifest.tsv --report metrics/{プロジェクト名}-token-usage.md` を実行する
6. レポートの total を累積トークンとして `sprint-metrics.md` セクション 2 に転記する
